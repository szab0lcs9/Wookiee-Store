...
<form action="{{ route('product.edit', $product) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-md-10 col-lg-8 mx-auto">
            <h4 class="display-4">{{ __('Editing') }} {{ $product->title }}</h4>
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" accept="image/*" class="form-control {{ $errors->has('image') ? 'is-invalid' : '' }}" name="image" value="{{ old('price', $product->image) }}">
                        @if ($errors->has('image'))
